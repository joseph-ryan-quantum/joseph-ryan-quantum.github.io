...
\indent Recipient of William L. Williams Award (\$7,500) for thesis on QCD color entanglement (LHCb).
...
\begin{itemize}
    \item J. M. Ryan \textit{et al.}, ``Experimental Measurement of Quantum First-Passage-Time Distributions,'' \textit{under review at PRL} (2025). 
    \href{https://doi.org/10.48550/arXiv.2508.21790}{arXiv:2508.21790}. Featured in \textit{Quantum Zeitgeist}.
\end{itemize}
